...
<select id="selectb" class="form-select" aria-label="Default select example">
	<option selected value="#sgt-0">First Option</option>
	<option value="#sgt-1">2nd Option</option>
	<option value="#sgt-2">3rd Option</option>
	<option value="#sgt-3">4th Option</option>
	<option value="#sgt-4">5th Option</option>
	<option value="#sgt-5">6th Option</option>
	<option value="#sgt-6">7th Option</option>
	<option value="#sgt-7">8th Option</option>
	<option value="#sgt-8">9th Option</option>
	<option value="#sgt-9">10th Option</option>
</select>
