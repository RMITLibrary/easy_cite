...
The Australian Government Style Manual, on which our RMIT Harvard referencing style is based, contains no guidelines for referencing AI-generated content or for referencing software programs. As the RMIT Harvard style is very similar to the APA 7th style, the guidelines below are based on the current APA guidelines for referencing AI-generated content. 
...
RMIT (2026) or (RMIT 2026)

**Reference list entry template and example - shareable URL:**

Author (Year) Title of software program [Format], accessed Day Month Year. URL

OpenAI (2026) ChatGPT [Large language model], accessed 2 February 2026. https://chat.openai.com/share/12345678912345

**Reference list entry template and example - appendix:**

Rule: Author (Year) Title of software program [Format], accessed Day Month Year. URL. Appendix.

RMIT (2026). Val [Large language model], accessed 30 January 2026. https://val.rmit.edu.au/. See Appendix A for prompt and output.
...
For AI-generated images from published sources, include a figure number and details about the image (including the source) in the caption below the image. Follow the RMIT Harvard caption guidelines in Easy Cite. Include the published source in your reference list.
