...
**Please note** that the guidelines on how to reference AI tools have been updated in February 2026. The APA 7th style manual editors updated their guidance on acknowledging and referencing AI-generated content in September 2025 (McAdoo et al., 2025). The information below is based on this updated guidance.
...
For more information, see the RMIT Copyright library guide.
...
In your reference list, include an entry for the AI tool. Please see the **Citing and referencing AI-generated content** section on this page for the format.
...
Use the AI Company Name as the author (i.e., OpenAI), and the year when the content was generated.

Author (year) or (Author year)

OpenAI (2026) or (OpenAI, 2026)

 #### Reference list entries:

If a shareable URL to the content is available, include it in your reference list entry.
If the content is not shareable, include the prompt used and the output generated in an appendix. Include the general URL for the tool and a note about the appendix in the reference list entry.

**Reference list template and example - shareable URL:**

AI Company Name. (year, month day). *Title of chat in italics* [Description]. Tool Name/Model. Shareable URL

OpenAI. (2026, February 2). *Book recommendations 2026* [Generative AI chat]. ChatGPT. https://chatgpt.com/share/1234567812345 

**Reference list template and example - appendix:**

AI Company Name. (year, month day). Title of chat in italics [Description]. Tool Name/Model. Appendix

RMIT. (2026, January 30). *History of Hansard* [Generative AI chat]. Val OpenAI GPT-4.1. https://val.rmit.edu.au/. See Appendix A for prompt and output

### AI-generated images

The updated APA 7th guidance does not provide specific guidance on referencing AI-generated images. The advice below is based the Easy Cite APA 7th guidance for using and referencing images [using and referencing images](https://www.lib.rmit.edu.au/easy-cite/?styleguide=styleguide-3#stn-7).

#### AI-generated images that you have created:
To include the image in your work provide a figure number in bold and brief title in italics above the image. Below the image, provide a caption that explains that the work was generated by an AI tool, and what prompt was used. No reference list entry is required for an AI-generated image that you have produced.
...
For AI-generated images from published sources, reference the published source in the caption below the figure following the instructions for generating APA 7th style captions in [Easy Cite](https://www.lib.rmit.edu.au/easy-cite/?styleguide=styleguide-3#stn-7#subtype-36). Include a figure number and a brief title above the image, and information about the image, including the source, in the caption below the image. Also include the published source in your reference list using the standard APA guidelines for the relevant source (e.g. a newspaper article).

McAdoo, T., Denneny, S., & Lee, C. (2025). Citing generative AI in APA Style: Part 1—Reference formats. APA Style. https://apastyle.apa.org/blog/cite-generative-ai-references 
