...
**Guide**
> Author. (Year). _Title of software program_ (Version) [Format]. Publisher*. URL
...
**Example**
> {.hanging-indent}OpenAI. (2023). _ChatGPT_ (May 24 version) [Large language model]. https://chat.openai.com/share/81f2e81f-f137-41b6-9881-39af1672ae3c {/.hanging-indent}
...
**Guide**
> _Note_. Description of figure. From: "Title of article/book/webpage etc", by A.A. Author, year of publication, _Journal/Newspaper title_ (if applicable), _volume number_ (if applicable), issue number (if applicable), page number/s (if applicable), DOI (if applicable), copyright year and owner.
