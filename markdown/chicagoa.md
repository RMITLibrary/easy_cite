...
Note number. Output generated using [AI tool used], Month Day, Year, Creator of tool, URL.

1. Text generated using ChatGPT, February 2, 2026, OpenAI, https://chatgpt.com/share/1234567812345

**Footnote template and example - appendix:**

Note number. Output generated using [AI tool used], Month Day, Year, Creator of tool, URL, Appendix.

1. Text generated using Val, January 30, 2026, RMIT, https://val.rmit.edu.au/, see Appendix A for prompt and output.
