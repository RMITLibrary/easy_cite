...
<!-- Indigenous knowledges - links to the eight type menu item -->
###### start-type-content
<!-- -->
...
The IEEE referencing guide does not currently contain any specific guidelines for referencing AI-generated content. We have adapted the software referencing guidelines. 
...
**Reference list entry template and example - shareable URL:**

Reference number. Title of Software. (year), Publisher Name. Accessed: Mon. DD, YYYY. [Type of Medium]. Available: site/path/file

1. ChatGPT (2026), OpenAI. Accessed: Feb. 2, 2026. [Online]. Available: https://chat.openai.com/share/1234567812345

**Reference list entry template and example - appendix:**

Reference number. Title of Software. (year), Publisher Name. Accessed: Mon. DD, YYYY. [Type of Medium]. Available: site/path/file (link to the general tool). Appendix.

1. Val. (2026), RMIT. Accessed: Jan. 30, 2026. [Online]. Available: https://val.rmit.edu.au/. See Appendix A for prompt and output.
...
If using reproduced images, the IEEE style advice is to reference the published source, using a numbered in-text citation that matches the corresponding reference list entry. If including the AI-generated image in your work, include information and a numbered citation in the figure caption below the image, and include the published source in your reference list using the IEEE guidelines in Easy Cite.
