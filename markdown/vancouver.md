...
I used ChatGPT (OpenAI, 2026) to provide topic suggestions for my research project. (1)

I used the Writing Help persona in Val (RMIT, 2026) to provide feedback on my assignment draft. (2)
...
The NLM style guide includes guidelines for referencing a number of internet source types. We have adapted these guidelines below, as we believe this is the best match for the style. 
...
Reference number. Name of AI tool [Type of medium]. Creator of tool; YYYY [cited YYYY Mon DD]. Available from URL 

1. ChatGPT [Internet]. OpenAI; 2026 [cited 2026 Feb 2]. Available from https://chat.openai.com/share/12345678912345

**Reference list entry template and example - appendix:**

Reference number. Name of AI tool [Type of medium]. Creator of tool; YYYY Mon [cited YYYY Mon DD]. Available from URL. Appendix.

1. Val [Internet]. RMIT 2026 [cited 2026 Feb 2]. Available from https://val.rmit.edu.au/. See Appendix A for prompt and output.
...
In a caption below the image, include the same description as in the published source and include a numbered in-text citation that matches the corresponding reference list entry to the published source.
