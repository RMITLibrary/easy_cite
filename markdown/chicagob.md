...
In your reference list or bibliography, include an entry for the AI tool. Please see the **Citing and referencing AI-generated content** section on this page for the format.
...
The Chicago Manual of Style editors have included a brief section on citing AI-generated content in the 18th edition. We have adapted these guidelines to accommodate the current Australian copyright advice that AI tools cannot be listed as authors - instead state that the output was generated using the AI tool.

Include the date the content was generated and a shareable URL to the content (if available). If the content is not shareable, include the prompt used and the output generated in an appendix.

**In-text citation template and examples:**

Use the company as the author, rather than the AI tool.

Author (year) or (Author year)

OpenAI (2026) or (RMIT 2026)
...
Author. Year. Name of tool. Month Day, Year. URL

OpenAI. 2026. ChatGPT. February 2, 2026. https://chatgpt.com/share/1234567812345

**Reference list template and example - appendix:**

Author. Year. Name of tool. Month Day, Year. URL. Appendix.

RMIT. 2026. Val. January 30, 2026. https://val.rmit.edu.au/. See Appendix A for prompt and output.

### AI-generated images

As stated in the [RMIT Easy Cite Chicago guides](https://www.lib.rmit.edu.au/easy-cite/?styleguide=styleguide-5#stn-7#subtype-32), visual materials used in assessment tasks do not need the copyright permissions that are required for publishing or commercial use. However, it is essential that you give credit to the creator of the work and reference it in your work.

**AI-generated images that you have created:**

Follow the [caption rules for your own work](https://www.lib.rmit.edu.au/easy-cite/?styleguide=styleguide-5#stn-7#subtype-34). Include the AI tool that was used as well as the prompt.
...
**AI-generated image from published sources:**
